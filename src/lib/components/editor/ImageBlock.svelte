<script lang="ts">
    ...
    async function handleFileSelect(e: Event) {
        ...
        // Ensure editing mode is on when uploading
        ...
        try {
            ...
            uploading = false;
            // Maybe we want to keep editing mode on? Or turn it off?
            // Usually uploading doesn't require "editing" mode to persist, but
            // for consistency let's turn it off after upload
